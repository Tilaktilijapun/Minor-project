...
$product_id = 12; // Updated to correct ID for Samsung Galaxy Watch
        ...
        if ($product && isset($product['stock']) && $product['stock'] > 0) {
            if (isset($_SESSION['cart'][$product_id])) {
                ...
                $_SESSION['cart'][$product_id] = [
                    'name' => $product['name'] ?? 'Samsung Galaxy Watch',
                    'price' => $product['price'] ?? 20000,
                    'image' => $product['image'] ?? '/minor project/assets/images/Montre-Samsung-galaxy_watch.jpg',
                    'quantity' => 1
                ];
            }
            header('Location: /minor project/product/Samsung Galaxy Watch.php?added=1');
            exit;
        }
...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title>Samsung Galaxy Watch - SnapCart</title>
    </head>
    <body>
        <div class="side-nav">
            <h3>Menu</h3>
        ...
        <div class="container">
            <div class="card">
                <img src="/minor project/assets/images/Montre-Samsung-galaxy_watch.jpg" alt="Montre-Samsung-galaxy_watch" class="card__img"> 
                <!-- <div class="card__content">  -->
                     <div class="card__data">
                         <h1 class="card__title"> Samsung Galaxy Watch </h1>
                         <span class="card__preci">Rs.20000</span>
                         <p class="card__description">
                            Smart watch with fitness tracking and smartphone connectivity features.
                        </p>
        ...
        <div class="reviews">
            ...
            <div class="review-card">
                <span>★★★★★</span>
                <p>Great battery life and fitness tracking!</p>
            </div>
            <div class="review-card">
                <span>★★★★☆</span>
