...
$product_id = 9; // Updated to correct ID for HP Victus
        ...
        if ($product && isset($product['stock']) && $product['stock'] > 0) {
            if (isset($_SESSION['cart'][$product_id])) {
                ...
                $_SESSION['cart'][$product_id] = [
                    'name' => $product['name'] ?? 'HP Victus',
                    'price' => $product['price'] ?? 125000,
                    'image' => $product['image'] ?? '/minor project/assets/images/HP-victus.jpg',
                    'quantity' => 1
                ];
            }
            header('Location: /minor project/product/HP Victus.php?added=1');
            exit;
        }
...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title>HP Victus - SnapCart</title>
    </head>
    <body>
        <div class="side-nav">
            <h3>Menu</h3>
        ...
        <div class="container">
            <div class="card">
                <img src="/minor project/assets/images/HP-victus.jpg" alt="Hpvictus" class="card__img"> 
                <!-- <div class="card__content">  -->
                     <div class="card__data">
                         <h1 class="card__title">HP-victus </h1>
                         <span class="card__preci">Rs.125000</span>
                         <p class="card__description">Possibly an informational page about the HP Victus series, a gaming laptop lineup.
                        </p>
