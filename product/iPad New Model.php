...
$product_id = 5; // Updated to correct ID for iPad
        ...
        if ($product && isset($product['stock']) && $product['stock'] > 0) {
            if (isset($_SESSION['cart'][$product_id])) {
                ...
                $_SESSION['cart'][$product_id] = [
                    'name' => $product['name'] ?? 'iPad with new feature',
                    'price' => $product['price'] ?? 120000,
                    'image' => $product['image'] ?? '/minor project/assets/images/ipad1.jpg',
                    'quantity' => 1
                ];
            }
            header('Location: /minor project/product/iPad New Model.php?added=1');
            exit;
        }
...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title>iPad with new features - SnapCart</title>
    </head>
    <body>
        <div class="side-nav">
            <h3>Menu</h3>
        ...
        <div class="container">
            <div class="card">
                <img src="/minor project/assets/images/ipad1.jpg" alt="ipad1" class="card__img"> 
                <!-- <div class="card__content">  -->
                     <div class="card__data">
                         <h1 class="card__title"> iPad with new feature </h1>
                         <span class="card__preci">Rs.120000</span>
                         <p class="card__description">Similar to the previous file, but this one may highlight new features of an upcoming iPad model
                        </p>
        ...
        <div class="reviews">
            ...
            <div class="review-card">
                <span>★★★★★</span>
                <p>Amazing tablet, great for drawing!</p>
            </div>
            <div class="review-card">
                <span>★★★★☆</span>
                <p>New features are impressive but pricey.</p>
            </div>
        </div>
        <div class="carousel">
