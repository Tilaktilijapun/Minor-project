        ...
        if ($product && isset($product['stock']) && $product['stock'] > 0) {
            if (isset($_SESSION['cart'][$product_id])) {
                ...
                $_SESSION['cart'][$product_id] = [
                    'name' => $product['name'] ?? 'MacBook 3 Pro',
                    'price' => $product['price'] ?? 180000,
                    'image' => $product['image'] ?? '/minor project/assets/images/macbook.webp',
                    'quantity' => 1
                ];
            }
            header('Location: /minor project/product/MacBook 3 Pro.php?added=1');
            exit;
        }
...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title>MacBook 3 Pro - SnapCart</title>
    </head>
    <body>
        <div class="side-nav">
            <h3>Menu</h3>
        ...
        <div class="container">
            <div class="card">
                <img src="/minor project/assets/images/macbook.webp" alt="MacBook 3 Pro" class="card__img"> 
                <!-- <div class="card__content">  -->
                     <div class="card__data">
                         <h1 class="card__title">MacBook 3 Pro</h1>
                         <span class="card__preci">Rs.180000</span>
                         <p class="card__description">Latest MacBook 3 Pro with advanced features and powerful performance
                        </p>
        ...
        <div class="reviews">
            ...
            <div class="review-card">
                <span>★★★★★</span>
                <p>Excellent performance and battery life!</p>
            </div>
            <div class="review-card">
                <span>★★★★☆</span>
                <p>Great laptop but a bit expensive.</p>
            </div>
        </div>
        <div class="carousel">
            ...
            <div class="related-product-card">
                <a href="/minor project/product/Digital Watch with Fitness.php" > <img src="/minor project/assets/images/Watch.png" alt="Watch"></a>
            <h3>Digital Watch</h3>
            <p>Rs. 5,000</p>
