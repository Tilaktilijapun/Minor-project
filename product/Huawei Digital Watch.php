...
$product_id = 13; // Updated to correct ID for Huawei Digital Watch
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['add_to_cart'])) {
        ...
        if ($product && isset($product['stock']) && $product['stock'] > 0) {
            if (isset($_SESSION['cart'][$product_id])) {
                ...
                $_SESSION['cart'][$product_id] = [
                    ...
                    'name' => $product['name'] ?? 'Huawei Digital Watch',
                    'price' => $product['price'] ?? 50000,
                    'image' => $product['image'] ?? '/minor project/assets/images/exclusive.png',
                    'quantity' => 1
                ];
            }
            header('Location: /minor project/product/Huawei Digital Watch.php?added=1');
            exit;
        }
        ...
        if ($product && isset($product['stock']) && $product['stock'] > 0) {
            ...
            header('Location: /minor project/cart/view-cart.php'); // Changed to view-cart.php
            exit;
        }
    }
}
...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title>Huawei Digital Watch - SnapCart</title>
    </head>
    <body>
        <div class="side-nav">
            <h3>Menu</h3>
        ...
        <div class="container">
            <div class="card">
                <img src="/minor project/assets/images/exclusive.png" alt="Huawei Digital Watch" class="card__img"> 
                <!-- <div class="card__content">  -->
                     <div class="card__data">
                         <h1 class="card__title">Huawei Digital Watch – Smart, Stylish & Powerful!  </h1>
                         <span class="card__preci">Rs.50000</span>
                         <p class="card__description">The blends sleek design with cutting-edge technology!⌚🔥
                        </p>
