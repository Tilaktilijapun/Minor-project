...
$product_id = 2; // Updated to correct ID for iPad
        ...
        if (isset($product['stock']) && $product['stock'] > 0) {
            if (isset($_SESSION['cart'][$product_id])) {
                ...
                $_SESSION['cart'][$product_id] = [
                    'name' => $product['name'] ?? 'iPad',
                    'price' => $product['price'] ?? 85000,
                    'image' => $product['image'] ?? '/minor project/assets/images/ipad.jpg',
                    'quantity' => 1
                ];
            }
            header('Location: /minor project/product/iPad.php?added=1');
            exit;
        }
...
<!DOCTYPE html>
    ...
    <body>
        ...
        <div class="container">
            <div class="card">
                <img src="/minor project/assets/images/ipad.jpg" alt="ipad" class="card__img"> 
                <!-- <div class="card__content">  -->
                     <div class="card__data">
                         <h1 class="card__title"> iPad </h1>
                         <span class="card__preci"> Rs.85000</span>
                         <p class="card__description">A webpage that might provide details about Apple's iPad lineup.
                        </p>
        ...
        <div class="reviews">
            ...
            <div class="review-card">
                <span>★★★★★</span>
                <p>Great tablet for everyday use!</p>
            </div>
            <div class="review-card">
                <span>★★★★☆</span>
                <p>Good performance but could use more storage.</p>
            </div>
        </div>
        <div class="carousel">
