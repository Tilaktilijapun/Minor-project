        ...
        if ($product && isset($product['stock']) && $product['stock'] > 0) {
            if (isset($_SESSION['cart'][$product_id])) {
                ...
                $_SESSION['cart'][$product_id] = [
                    'name' => $product['name'] ?? 'iPhone 16 Pro Max',
                    'price' => $product['price'] ?? 200000,
                    'image' => $product['image'] ?? '/minor project/assets/images/iphone16 pro max.jpg',
                    'quantity' => 1
                ];
            }
            header('Location: /minor project/product/iPhone 16 Pro Max.php?added=1');
            exit;
        }
...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title>iPhone 16 Pro Max - SnapCart</title>
    </head>
    <body>
        <div class="side-nav">
            <h3>Menu</h3>
        ...
        <div class="container">
            <div class="card">
                <img src="/minor project/assets/images/iphone16 pro max.jpg" alt="iphone16" class="card__img"> 
                <!-- <div class="card__content">  -->
                     <div class="card__data">
                         <h1 class="card__title">iPhone 16 Pro Max</h1>
                         <span class="card__preci">Rs.200000</span>
                         <p class="card__description">
                            The latest flagship iPhone with advanced features and premium design.
                        </p>
