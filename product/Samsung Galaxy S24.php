...
$product_id = 6; // Updated to correct ID for Samsung Galaxy S24
        ...
        if ($product && isset($product['stock']) && $product['stock'] > 0) {
            if (isset($_SESSION['cart'][$product_id])) {
                ...
                $_SESSION['cart'][$product_id] = [
                    'name' => $product['name'] ?? 'Samsung Galaxy S24',
                    'price' => $product['price'] ?? 230000,
                    'image' => $product['image'] ?? '/minor project/assets/images/samsung-galaxy s24 ultra.jpg',
                    'quantity' => 1
                ];
            }
            header('Location: /minor project/product/Samsung Galaxy S24.php?added=1');
            exit;
        }
...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title>Samsung Galaxy S24 - SnapCart</title>
    </head>
    <body>
        <div class="side-nav">
            <h3>Menu</h3>
        ...
        <div class="container">
            <div class="card">
                <img src="/minor project/assets/images/samsung-galaxy s24 ultra.jpg" alt="samsung-galaxy" class="card__img"> 
                <!-- <div class="card__content">  -->
                     <div class="card__data">
                         <h1 class="card__title"> Samsung Galaxy S24</h1>
                         <span class="card__preci">Rs.230000</span>
                         <p class="card__description">Latest Samsung flagship with advanced AI features and powerful camera system.</p>
                         ...
                         <!-- Updated button styling to match iPad page -->
        ...
        <div class="reviews">
            ...
            <div class="review-card">
                <span>★★★★★</span>
                <p>Amazing camera quality and AI features!</p>
            </div>
            <div class="review-card">
                <span>★★★★☆</span>
                <p>Great phone but expensive.</p>
            </div>
        </div>
        <div class="carousel">
