...
$product_id = 7; // Updated to correct ID for MacBook Pro
        ...
        if ($product && isset($product['stock']) && $product['stock'] > 0) {
            if (isset($_SESSION['cart'][$product_id])) {
                ...
                $_SESSION['cart'][$product_id] = [
                    ...
                    'image' => $product['image'] ?? '/minor project/assets/images/macbook1.jpg',
                    'quantity' => 1
                ];
            }
            header('Location: /minor project/product/MacBook Pro.php?added=1');
            exit;
        }
...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title>MacBook Pro - SnapCart</title>
    </head>
    <body>
        <div class="side-nav">
            <h3>Menu</h3>
        ...
        <div class="container">
            <div class="card">
                <img src="/minor project/assets/images/macbook1.jpg" alt="macbookpro" class="card__img"> 
                <!-- <div class="card__content">  -->
                     <div class="card__data">
                         <h1 class="card__title">Macbook pro </h1>
                         <span class="card__preci"> Rs.150000</span>
                         <p class="card__description">A dedicated webpage for Apple's MacBook Pro, possibly comparing different models.
                        </p>
        ...
        <div class="reviews">
            ...
            <div class="review-card">
                <span>★★★★★</span>
                <p>Excellent performance for professional work!</p>
            </div>
            <div class="review-card">
                <span>★★★★☆</span>
                <p>Great laptop but expensive.</p>
            </div>
        </div>
        <div class="carousel">
