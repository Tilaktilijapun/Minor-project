        ...
        if ($product && isset($product['stock']) && $product['stock'] > 0) {
            if (isset($_SESSION['cart'][$product_id])) {
                ...
                $_SESSION['cart'][$product_id] = [
                    'name' => $product['name'] ?? 'Lenovo Legion 5 2024 RTX 4050',
                    'price' => $product['price'] ?? 200000,
                    'image' => $product['image'] ?? '/minor project/assets/images/Lenovo-Legion-5-2024-.jpg',
                    'quantity' => 1
                ];
            }
            header('Location: /minor project/product/Lenovo Legion 5 2024 RTX 4050.php?added=1');
            exit;
        }
...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title>Lenovo Legion 5 2024 RTX 4050 - SnapCart</title>
    </head>
    <body>
        <div class="side-nav">
            <h3>Menu</h3>
        ...
        <div class="container">
            <div class="card">
                <img src="/minor project/assets/images/Lenovo-Legion-5-2024-.jpg" alt="Huawei Digital Watch" class="card__img"> 
                <!-- <div class="card__content">  -->
                     <div class="card__data">
                         <h1 class="card__title">Lenovo Legion 5 2024 RTX 4050  </h1>
                         <span class="card__preci">Rs.200000</span>
                         <p class="card__description">Latest gaming laptop with RTX 4050 graphics</p>
        ...
        <div class="carousel">
            <div class="related-product-card">
                <a href="/minor project/product/HP_home_victus.php">  <img src="/minor project/assets/images/Hpvictus.png" alt="Laptop"></a>
                <h3>Hp victus</h3>
                <p>Rs. 106,000</p>
